...
export const CATEGORIES = [
  {
    ...
    rows: [
      ...
      ['waterGlasses', 'otherDrinks'],
      ['caffeineCups', 'caffeineLastTime'],
      ['alcoholUnits', 'sugar'],
      ['supplements'],
    ],
    fields: [
      ...
      { key: 'waterGlasses', type: 'number', min: 0, max: 10, step: 0.1, convert: 'volume' },
      { key: 'otherDrinks', type: 'text' },
  ...
  },
  {
    ...
    icon: '⚖️',
    fields: [
      { key: 'weightKg', type: 'number', min: 20, max: 400, step: 0.1, convert: 'weight' },
      { key: 'heightCm', type: 'number', min: 30, max: 260, step: 0.5, convert: 'length' },
      { key: 'bmi', type: 'bmi' },
      { key: 'waistCm', type: 'number', min: 30, max: 250, step: 0.5, convert: 'length' },
      ...
      { key: 'temperatureC', type: 'number', min: 33, max: 43, step: 0.1, convert: 'temperature' },
      { key: 'bloodGlucose', type: 'number', min: 1, max: 40, step: 0.1, convert: 'glucose' },
    ],
  },
  {
    id: 'sleep',
